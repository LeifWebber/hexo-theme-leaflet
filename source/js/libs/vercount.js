    ...
    t = {
        fetch: async function (t) {
            ...
            try {
                ...
                let i = s;
                s.startsWith("http") || (console.warn("Invalid URL protocol detected. Only HTTP and HTTPS are supported."), i = "https://local.file/invalid-protocol");
                try {
                    ...
                    const s = (t => {
                        if (t && t.status) {
                            ...
                            if ("error" === t.status) return console.warn(`API error: ${t.message}`, t), {
                                site_uv: 0,
                                site_pv: 0,
                                page_pv: 0
                            }
        ...
        counterIds: ["site_pv", "page_pv", "site_uv"], updateText: function (t) {
        ...
        a || "interactive" === document.readyState || "complete" === document.readyState ? t.call(document) : (o.push(t), document.addEventListener("DOMContentLoaded", r))
    })((() => {
